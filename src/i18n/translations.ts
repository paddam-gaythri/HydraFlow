...
export const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    // Payment Gateway & UPI UI
    payNow: 'Pay Now',
    paymentProcessing: '💳 Payment Processing',
    paymentSuccessful: '🎉 Payment Successful!',
    paymentFailed: 'Payment was not completed.',
    paymentPending: 'Payment is still being verified.',
    ...
    completeWithUpiApp: 'Complete the payment using your UPI app (Google Pay, PhonePe, Paytm, BHIM).',
    continueToHydraFlow: 'Continue to HydraFlow',
    checkPaymentStatus: 'Check Payment Status',
    tryAgain: 'Try Again',
    proActiveTitle: 'Your Pro plan is now active.',
    annualActiveTitle: '⭐ Annual Plan Active (₹799/year)',
    directUpiTitle: 'Pay directly using UPI',
    merchantUpiLabel: 'Merchant UPI ID',
    directUpiDisclaimer: 'After completing a direct UPI payment, payment verification may require manual confirmation unless the transaction is processed through the payment gateway.',
    securePaymentNotice: '256-bit SSL Encrypted • Powered by Razorpay UPI Gateway',
    desktopQrInstructionsHeader: 'How to pay with UPI QR Code:',
    desktopQrStep1: '1. Open Google Pay, PhonePe, Paytm, or BHIM on your phone.',
    desktopQrStep2: '2. Scan the Razorpay UPI QR code shown above.',
    desktopQrStep3: '3. Approve the payment in your UPI app.',
    desktopQrStep4: '4. Return here. Payment status will be verified automatically.',
  ...
  hi: {
    ...
    paymentProcessing: '💳 भुगतान प्रक्रियाधीन है',
    paymentSuccessful: '🎉 भुगतान सफल रहा!',
    paymentFailed: 'भुगतान पूरा नहीं हो सका।',
    paymentPending: 'भुगतान का सत्यापन अभी भी जारी है।',
    ...
    completeWithUpiApp: 'अपने UPI ऐप (Google Pay, PhonePe, Paytm, BHIM) का उपयोग करके भुगतान पूरा करें।',
    continueToHydraFlow: 'हाइड्राफ्लो जारी रखें',
    checkPaymentStatus: 'भुगतान स्थिति जांचें',
    tryAgain: 'पुनः प्रयास करें',
    proActiveTitle: 'आपका प्रो प्लान अब सक्रिय है।',
    annualActiveTitle: '⭐ वार्षिक प्लान सक्रिय (₹799/वर्ष)',
    directUpiTitle: 'सीधे UPI का उपयोग करके भुगतान करें',
    merchantUpiLabel: 'मर्चेंट UPI आईडी',
    directUpiDisclaimer: 'सीधे UPI से भुगतान करने के बाद, यदि भुगतान गेटवे के माध्यम से संसाधित नहीं किया जाता है तो सत्यापन के लिए मैन्युअल पुष्टि की आवश्यकता हो सकती है।',
    securePaymentNotice: '256-बिट SSL सुरक्षित • रेज़रपे UPI गेटवे द्वारा संचालित',
    desktopQrInstructionsHeader: 'UPI QR कोड से भुगतान कैसे करें:',
    desktopQrStep1: '1. अपने फोन पर Google Pay, PhonePe, Paytm या BHIM खोलें।',
    desktopQrStep2: '2. ऊपर दिखाया गया रेज़रपे UPI QR कोड स्कैन करें।',
    desktopQrStep3: '3. अपने UPI ऐप में भुगतान स्वीकृत करें।',
    desktopQrStep4: '4. यहां वापस आएं। भुगतान स्थिति स्वचालित रूप से सत्यापित हो जाएगी।',
  ...
  gu: {
    ...
    paymentProcessing: '💳 પેમેન્ટ પ્રક્રિયામાં છે',
    paymentSuccessful: '🎉 પેમેન્ટ સફળ રહ્યું!',
    paymentFailed: 'પેમેન્ટ પૂર્ણ થયું નથી.',
    paymentPending: 'પેમેન્ટની ચકાસણી હજુ ચાલુ છે.',
    checkingPaymentStatus: 'પેમેન્ટ સ્ટેટસ તપાસી રહ્યા છીએ...',
    retryPayment: 'ફરી પ્રયાસ કરો',
    cancelPayment: 'પેમેન્ટ રદ કરો',
    copyUpiId: 'UPI ID કૉપિ કરો',
    upiCopied: 'UPI ID કૉપિ થઈ ગઈ!',
    upiPayment: 'UPI પેમેન્ટ',
    scanQrCode: 'QR કોડ સ્કેન કરો',
    secondsRemaining: '{seconds} સેકન્ડ બાકી',
    proPlan: 'પ્રો પ્લાન',
    annualPlan: 'વાર્ષિક પ્લાન',
    completeWithUpiApp: 'તમારી UPI એપ (Google Pay, PhonePe, Paytm, BHIM) નો ઉપયોગ કરીને પેમેન્ટ પૂર્ણ કરો.',
    continueToHydraFlow: 'હાઇડ્રાફ્લો ચાલુ રાખો',
    checkPaymentStatus: 'પેમેન્ટ સ્ટેટસ તપાસો',
    tryAgain: 'ફરી પ્રયાસ કરો',
    proActiveTitle: 'તમારો પ્રો પ્લાન હવે સક્રિય છે.',
    annualActiveTitle: '⭐ વાર્ષિક પ્લાન સક્રિય (₹799/વર્ષ)',
    directUpiTitle: 'સીધા UPI વડે ચૂકવણી કરો',
    merchantUpiLabel: 'મર્ચન્ટ UPI ID',
    directUpiDisclaimer: 'ડાયરેક્ટ UPI પેમેન્ટ કર્યા પછી, જો પેમેન્ટ ગેટવે દ્વારા પ્રોસેસ ન થાય તો પેમેન્ટ વેરિફિકેશન માટે મેન્યુઅલ કન્ફર્મેશનની જરૂર પડી શકે છે.',
    securePaymentNotice: '256-બીટ SSL સુરક્ષિત • Razorpay UPI ગેટવે દ્વારા સંચાલિત',
    desktopQrInstructionsHeader: 'UPI QR કોડ વડે પેમેન્ટ કેવી રીતે કરવું:',
    desktopQrStep1: '1. તમારા ફોનમાં Google Pay, PhonePe, Paytm અથવા BHIM ખોલો.',
    desktopQrStep2: '2. ઉપર બતાવેલ Razorpay UPI QR કોડ સ્કેન કરો.',
    desktopQrStep3: '3. તમારી UPI એપમાં પેમેન્ટ મંજૂર કરો.',
    desktopQrStep4: '4. અહીં પાછા આવો. પેમેન્ટ સ્ટેટસ આપમેળે વેરિફાઈ થશે.',
  ...
  te: {
    ...
    paymentProcessing: '💳 పేమెంట్ ప్రాసెస్ అవుతోంది',
    paymentSuccessful: '🎉 పేమెంట్ విజయవంతమైంది!',
    paymentFailed: 'పేమెంట్ పూర్తి కాలేదు.',
    paymentPending: 'పేమెంట్ స్థితి ఇంకా తనిఖీ చేయబడుతోంది.',
    checkingPaymentStatus: 'పేమెంట్ స్థితిని తనిఖీ చేస్తోంది...',
    retryPayment: 'మార్పుల కోసం ప్రయత్నించండి',
    cancelPayment: 'పేమెంట్ రద్దు చేయండి',
    copyUpiId: 'UPI ID కాపీ చేయండి',
    upiCopied: 'UPI ID కాపీ చేయబడింది!',
    upiPayment: 'UPI పేమెంట్',
    scanQrCode: 'QR కోడ్ స్కాన్ చేయండి',
    secondsRemaining: '{seconds} సెకన్లు మిగిలి ఉన్నాయి',
    proPlan: 'ప్రో ప్లాన్',
    annualPlan: 'వార్షిక ప్లాన్',
    completeWithUpiApp: 'మీ UPI యాప్ (Google Pay, PhonePe, Paytm, BHIM) ఉపయోగించి చెల్లింపు పూర్తి చేయండి.',
    continueToHydraFlow: 'హైడ్రాఫ్లో కి కొనసాగండి',
    checkPaymentStatus: 'పేమెంట్ స్థితిని తనిఖీ చేయండి',
    tryAgain: 'మళ్లీ ప్రయత్నించండి',
    proActiveTitle: 'మీ ప్రో ప్లాన్ ఇప్పుడు యాక్టివ్‌గా ఉంది.',
    annualActiveTitle: '⭐ వార్షిక ప్లాన్ యాక్టివ్ (₹799/సంవత్సరం)',
    directUpiTitle: 'నేరుగా UPI ద్వారా చెల్లించండి',
    merchantUpiLabel: 'మర్చంట్ UPI ID',
    directUpiDisclaimer: 'నేరుగా UPI ద్వారా చెల్లించిన తర్వాత, పేమెంట్ గేట్‌వే ద్వారా ప్రాసెస్ చేయకపోతే వెరిఫికేషన్ కోసం మాన్యువల్ నిర్ధారణ అవసరం కావచ్చు.',
    securePaymentNotice: '256-బిట్ SSL సురక్షితం • Razorpay UPI గేట్‌వే ద్వారా అందించబడింది',
    desktopQrInstructionsHeader: 'UPI QR కోడ్‌తో చెల్లించడం ఎలా:',
    desktopQrStep1: '1. మీ ఫోన్‌లో Google Pay, PhonePe, Paytm లేదా BHIM తెరవండి.',
    desktopQrStep2: '2. పైన చూపిన Razorpay UPI QR కోడ్‌ను స్కాన్ చేయండి.',
    desktopQrStep3: '3. మీ UPI యాప్‌లో చెల్లింపును ఆమోదించండి.',
    desktopQrStep4: '4. ఇక్కడకు తిరిగి రండి. పేమెంట్ స్థితి స్వయంచాలకంగా తనిఖీ చేయబడుతుంది.',
